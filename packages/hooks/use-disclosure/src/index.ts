 ...
 * close or toggle scenarios. It can be used to control feedback component
 * such as `Modal`, `AlertDialog`, `Drawer`, etc.
 * 
 * @see Docs https://fire-ui.com/docs/hooks/use-disclosure
 */
