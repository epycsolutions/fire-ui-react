...
export interface UseOutsideClickProps {
    ...
    /**
     * Function invoke when a click is triggered outside the
     * referenced element.
     */
...
/**
 * Example, used in components like Dialogs and Popovers, so they
 * can close when a user clicks outside them.
 */
