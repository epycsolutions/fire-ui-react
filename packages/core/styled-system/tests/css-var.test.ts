    ...
    ).toMatchInlineSnapshot(`
{
  ...
  '__cssVars': {
    '--fire-ring-color': 'rgba(66, 153, 225, 0.6)',
    '--fire-ring-inset': 'var(--fire-empty,/*!*/ /*!*/)',
    '--fire-ring-offset-color': '#fff',
    '--fire-ring-offset-shadow': '0 0 #0000',
    '--fire-ring-offset-width': '0px',
    '--fire-ring-shadow': '0 0 #0000',
    '--fire-space-x-reverse': '0',
    '--fire-space-y-reverse': '0',
    '--space-lg': '24px',
    '--space-md': '16px',
    '--space-sm': '8px',
  },
    ...
    expect(toCSSVar(theme)).toMatchInlineSnapshot(`
{
  ...
  '__cssVars': {
    ...
    '.fire-ui-dark &:not([data-theme]),[data-theme=dark] &:not([data-theme]),&[data-theme=dark]': {
