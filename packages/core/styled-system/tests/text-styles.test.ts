    ...
    ).toMatchInlineSnapshot(`
{
  '@media screen and (min-width: 30em)': {
    'color': 'red',
    'fontSize': 'var(--fire-fontSizes-4xl)',
    'marginTop': 'var(--fire-space-4)',
  },
  'color': 'blue',
  'fontSize': 'var(--fire-fontSizes-2xl)',
  'fontWeight': 'var(--fire-fontWeights-bold)',
  'marginTop': 'var(--fire-space-3)',
}
`)
})
