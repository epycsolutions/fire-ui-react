...
test('handles negative values from custom css var scale', () => {
    ...
    // Custom CSS variables are mapped to CSS vars controlled by fire
    expect(result).toMatchInlineSnapshot(`
    {
...
test('returns filter hueRotate css function', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
    {
      ...
      '--fire-hue-rotate': 'hue-rotate(90deg)',
      '--fire-invert': 'var(--fire-empty,/*!*/ /*!*/)',
      '--fire-saturate': 'var(--fire-empty,/*!*/ /*!*/)',
      '--fire-sepia': 'var(--fire-empty,/*!*/ /*!*/)',
      'filter': 'var(--fire-blur) var(--fire-brightness) var(--fire-contrast) var(--fire-grayscale) var(--fire-hue-rotate) var(--fire-invert) var(--fire-saturate) var(--fire-sepia) var(--fire-drop-shadow)',
    }
  `)
})
...
test('returns backdropFilter backdropHueRotate css function', () => {
    ...
    expect(result).toMatchInlineSnapshot(`
    {
      ...
      '--fire-backdrop-hue-rotate': 'hue-rotate(90deg)',
      ...
      'backdropFilter': 'var(--fire-backdrop-blur) var(--fire-backdrop-brightness) var(--fire-backdrop-contrast) var(--fire-backdrop-grayscale) var(--fire-backdrop-hue-rotate) var(--fire-backdrop-invert) var(--fire-backdrop-opacity) var(--fire-backdrop-saturate) var(--fire-backdrop-sepia)',
    }
  `)
})