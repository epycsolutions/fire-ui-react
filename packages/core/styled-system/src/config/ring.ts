...
export const ring: Config = {
    ...
    ringColor: t.colors('--fire-ring-color'),
    ringOffset: t.prop('--fire-ring-offset-width'),
    ringOffsetColor: t.colors('--fire-ring-offset-color'),
    ringInset: t.prop('--fire-ring-inset'),
}
