...
export function get(object: Record<string, any>, path: string | number, fallback?: any, index?: number) {
...
type Get = (object: Readonly<object>, path: string | number, fallback?: any, index?: number) => any
...
export const objectKeys = <T extends Dict>(object: T) => Object.keys(object) as unknown as (keyof T)[]
...
export const getCSSVar = (theme: Dict, scale: string, value: any) => theme.__cssMap?.[`${ scale }.${ value }`]?.varRef ?? value