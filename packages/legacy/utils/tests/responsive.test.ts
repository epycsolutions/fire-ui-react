...
test('should convert array to object value', () => {
    expect(arrayToObjectNotation([ '20px', null, null, '60px' ])).toEqual({ base: '20px', lg: '60px' })
    expect(arrayToObjectNotation([ '30px' ])).toEqual({ base: '30px' })
    expect(arrayToObjectNotation([ '30px', '50px' ])).toEqual({ base: '30px', sm: '50px' })
...
test('should work with createBreakpoints output', () => {
    expect(
        analyzeBreakpoints({
            base: '0em',
            sm: '320px',
