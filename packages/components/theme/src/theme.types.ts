...
export interface ComponentDefaultProps 
    extends Omit<ThemingProps, 'styleConfig'>, Dict {}

export interface ThemeComponentProps<T extends FireTheme = FireTheme>
...
export type ThemeComponentFunction<S, T extends FireTheme = FireTheme> = (
    props: ThemeComponentProps<T>
) => S

export type ThemingPropsThunk<S, T extends FireTheme = FireTheme> = 
    | S
...
export interface FireTheme extends Foundations {
