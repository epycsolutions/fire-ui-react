import { getCSSVar } from '@fire-ui/styled-system'
...
export const getColor = (theme: Dict, color: string, fallback?: string) => {
    ...
    try {
        ...
        // Returning back to stay consistent with TinyColor behavious so as to prevent breaking change
...
/**
 * Dtermines if the tone of given color is 'light' or 'dark'
 ...
 * 
 * @param color The color in hex, rgb, to hsl
 ...
 * based on the Web Content Accessibility Guildelines (Version 2.0).
 * 
...
interface RandomColorOptions {
    ...
    /**
     * List of olors to pick from at random
     */
    colors?: string[]
}
