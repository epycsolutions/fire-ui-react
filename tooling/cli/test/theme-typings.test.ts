...
describe('Theme typings', () => {
        ...
        expect(themeInterface).toMatchInlineSnapshot(`
            "
                ...
                export interface ThemeTypings extends BaseThemeTypings {
                    ...
                    layerStyles: "sm" | "md" | (string & {})
                    letterSpacing: "sm" | "md" | (string & {})
                    lineHeights: "sm" | "md" | (string & {})
                    radii: "sm" | "md" | (string & {})
                    shadows: "sm" | "md" | (string & {})
                    sizes: "sm" | "md" | (string & {})
                    space: "sm" | "md" | (string & {})
                    textStyles: "sm" | "md" | (string & {})
    ...
    it('should create typings for a theme for interface augmentation', async () => {
        ...
        expect(themeInterface).toMatchInlineSnapshot(`
            "
                // regenerate by running
                // npx @fire-ui/cli tokens path/to/your/theme.(js|ts) --template augmentation --out path/to/this/file
                import { BaseThemeTypings } from "@fire-ui/styled-system"
                declare module "@fire-ui/styled-system" {
